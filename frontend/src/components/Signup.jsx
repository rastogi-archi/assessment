...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://assessment-awxk.vercel.app/api/auth/signup', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-sky-100 px-4 py-10">
      <div className="w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200 shadow-2xl rounded-[32px] p-8 md:p-10">
        <h1 className="text-4xl font-semibold text-slate-900 text-center">Create account</h1>
        <p className="text-sm text-slate-500 text-center mt-2">Create your team account and start managing projects.</p>
